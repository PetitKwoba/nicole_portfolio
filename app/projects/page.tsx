...
export default function Projects() {
  return (
    <main className="py-20">
      ...
      <p className="mt-4 text-slate-700 max-w-3xl">These project placeholders are extracted from the resume experience — swap them for full case studies when available.</p>

      <ul className="mt-8 space-y-4">
        <li className="p-4 border rounded-md">
          <h3 className="font-medium">Secure Event Ticketing System — Data Fundamentals</h3>
          <div className="mt-2 flex items-center gap-2">
            <TechBadge>Supabase</TechBadge>
            <TechBadge>PostgreSQL</TechBadge>
            <TechBadge>RLS / SQL</TechBadge>
          </div>
          <p className="text-slate-600 text-sm mt-1">An upgraded Event Ticketing system that integrates Supabase Auth, Admin Roles, and Row Level Security (RLS) to ensure robust database protection and controlled data access. Built with Supabase (PostgreSQL) to manage users, events, tickets, and payments while enforcing role-based access control and the Least Privilege Principle.</p>
        ...
        <li className="p-4 border rounded-md">
          <h3 className="font-medium">Event Ticketing System — Data Tools</h3>
          <div className="mt-2 flex items-center gap-2">
            <TechBadge>Supabase</TechBadge>
            <TechBadge>PostgreSQL</TechBadge>
            <TechBadge>SQL</TechBadge>
          </div>
          <p className="text-slate-600 text-sm mt-1">A database-driven web application built with Supabase (PostgreSQL) enabling users to browse events, register, purchase tickets, and manage attendance in real time. The project includes SQL-based schema and documentation (schema.sql, data_dictionary.md, erd.md) designed for easy deployment to Supabase.</p>
          <div className="mt-3 text-slate-700 text-sm">
        ...
        <li className="p-4 border rounded-md">
          ...
          <p className="text-slate-600 text-sm mt-1">As a Community Volunteer (Sept 2024 — present) participated in outreach, collected and managed program data, produced documentation and reports summarizing program impacts, and supported direct mentorship activities for teenagers.</p>
          <div className="mt-3 text-slate-700 text-sm">
        ...
        <li className="p-4 border rounded-md">
          <h3 className="font-medium">Industrial Attachment — St. John's Community Centre (Tumikia Mtoto)</h3>
          <div className="mt-2 flex items-center gap-2">
            <TechBadge>Outreach</TechBadge>
            <TechBadge>Data</TechBadge>
          </div>
          <p className="text-slate-600 text-sm mt-1">During the May–Aug 2023 attachment, supported beneficiary record keeping and data entry, organized and digitized case files, assisted with awareness campaigns, and contributed to monitoring and evaluation documentation.</p>
          <div className="mt-3 text-slate-700 text-sm">
